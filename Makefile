...
version:
	# patch || minor
	@bumpversion patch --current-version ${VERSION} public/package.json public/package.develop.json public/package.production.json Makefile --list app/components/huayra-version.js
	make build
